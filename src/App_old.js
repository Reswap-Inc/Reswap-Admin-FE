...
import ListingOutlet from "./components/ListingOutlet.jsx";
import AddListing11 from "./pages/rough.js";
import JoyrideWrapper from "./components/JoyrideWrapper"; // ✅ Import Joyride
    ...
    <div>
      <BrowserRouter>
        <Routes>
          ...
          {/* All /web/admin/* routes are wrapped with Navbar, Layout, JoyrideWrapper elements*/}
          <Route
            path="/web/admin/"
            element={
              <>
                <Navbar />
                <Layout />
                <JoyrideWrapper /> {/* Add JoyrideWrapper here */}
              </>
            }
          >
            <Route index element={<Navigate to="/web/admin/home" replace />} />
