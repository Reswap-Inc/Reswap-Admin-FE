...
export const LOGOUT = `${BASE_URL}/api/auth/v1.2/logout?redirect_url=https://reswap.tmithun.com/login`;
export const REDIRECT_LOGIN = `${BASE_URL}/api/auth/v1.2/login?return_to=/web/admin/home`;
...
export const VALIDATE_ADDRESS = `${BASE_URL}/api/general/${VERSION}/validateAddress`;
export const REGISTRATION_DEVICES = `${BASE_URL}/api/general/${VERSION}/RegisterDevice`;
export const GET_GENDER_OPTIONS = `${BASE_URL}/api/general/${VERSION}/getGenderOptions`;
