...
export const links = [
...

  {
    ...
    links: [
      {
        name: 'Dashboard',
        icon: <AiOutlineShoppingCart />,paths:""
      }, {
        name: 'User Management',
        icon: <RiContactsLine />, paths:"users"
      },
      {
        name: 'Categories',
        icon: <IoMdContacts />, paths:"categories"
      },
      {
        name: 'Brands',
        icon: <RiContactsLine />,paths:"brand"
      },
      {
        name: 'Suppliers',
        icon: <RiContactsLine />,paths:"supplier" 
      },
     
      {
        name: 'Enquiries',
        icon: <RiContactsLine />,paths:"roleper"
      },
      {
        name: 'Banner',
        icon: <RiContactsLine />, paths:"banner"
      },
      {
        name: 'Settings',
        icon: <RiContactsLine />,paths:"setting"
      },
